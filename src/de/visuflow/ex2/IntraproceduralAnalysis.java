...
import de.visuflow.ex2.updated.IntraproceduralAnalysis.Tainted;
...
public class IntraproceduralAnalysis extends UpdateableForwardFlowAnalysis<Unit, Set<FlowAbstraction>> {
    ...
    public IntraproceduralAnalysis(IReporter reporter,Body b, Map<String,  Map<String, Map<Unit, Set<FlowAbstraction>>>> cache) {
        super(new ExceptionalUnitGraph(b));
        System.out.println("\n\n-------------------------"+b.getMethod().getSignature()+"--------------------------------------------"+"Normal");
...
//                        }
    ...
    public void doAnalyis(Map<String, Map<String, Map<Unit, Set<FlowAbstraction>>>> cache) {
     Map<String, Map<Unit, Set<FlowAbstraction>>>result =  super.doCachedAnalysis();
